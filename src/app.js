...
function buildPatternDocHeaderHtml(title){
  return `
    ...
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#6B6072;margin:0 0 20px 0;">An amigurumi pattern generated by Stitch Builder</p>
    ...
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">4.00mm crochet hook</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">Stuffing</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">2 8mm safety eyes</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">Stitch marker</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 20px 0;">Yarn needle</p>
    ...
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">sc — single crochet</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">inc — increase (2 sc in the same stitch)</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">dec — decrease (single crochet 2 stitches together)</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 4px 0;">st(s) — stitch(es)</p>
    <p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 20px 0;">rnd — round</p>
  `;
}
...
function buildPatternDocPieceHtml(heading, makeCount, colors, segments){
  ...
  html += `<p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 10px 0;">📷&nbsp;&nbsp;With <b>${escapeHtml(colorNames)}</b> yarn.</p>`;
  segments.forEach(seg=>{
    if(seg.kind==='table'){
      seg.rows.forEach(r=>{
        html += `<p style="font-family:Nunito, Arial, sans-serif;font-size:13px;color:#2B2130;margin:0 0 6px 0;">`
      ...
      html += `<p style="font-family:Nunito, Arial, sans-serif;font-size:12px;font-style:italic;color:#2B2130;margin:2px 0 14px 0;">`
